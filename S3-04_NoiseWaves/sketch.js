//Following example S3-03_SineWaves, here we utilize a Perlin noise 
//function to generate the position of the shapes.
...
function setup() {
  ...
  listOfColors[selArray];
  selArray = parseInt(random(6));
  getColor = listOfColors[selArray];
}
